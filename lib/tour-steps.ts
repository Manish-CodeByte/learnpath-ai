...
export const TOUR_STEPS: TourStep[] = [
    {
        targetId: "center",
        title: "Welcome to LearnPath AI",
        description: "Let's take a quick tour to help you get the most out of your new AI-powered learning companion.",
        position: "center"
    },
    {
    ...
    },
    {
        ...
        title: "Configure AI",
        description: "Visit Settings to add your API keys. LearnPath AI needs them to power its AI features.",
        position: "right"
    }
]
