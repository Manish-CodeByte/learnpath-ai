...
export default function OnboardingPage() {
    ...
    const handleNext = () => {
        ...
        if (step === 3 && !formData.groqApiKey.trim()) {
            toast.error("Gemini API key is recommended for AI features. You can add it later in settings.")
            return
        }
        setStep(prev => prev + 1)
    }
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toast.success("You’re all set! Welcome to LearnPath AI.")
            router.push('/')
        } catch (error) {
                            ...
                            {step === 1 && (
                                ...
                                >
                                    <div className="space-y-2">
                                        <h2 className="text-2xl font-bold tracking-tight">Welcome to LearnPath AI</h2>
                            ...
                            {step === 3 && (
                                ...
                                >
                                    <div className="space-y-2">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">Power up with Gemini (or your preferred LLM)</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <Alert variant="destructive">
                                        ...
                                        <AlertDescription>
                                            The Gemini (or LLM) API key enables AI-powered curriculum recommendations and personalized briefings. You can add it later if you prefer.
                                        </AlertDescription>
                                    </Alert>
                                    ...
                                    <Card className="bg-muted/30">
                                        <CardContent className="pt-4 space-y-4">
                                            <div className="flex items-center justify-between">
                                                <Label className="font-semibold">Gemini / LLM API Key</Label>
                                                <Button variant="link" size="sm" asChild className="h-auto p-0 text-xs">
                                                    <Link href="https://console.groq.com/keys" target="_blank" className="flex items-center gap-1">
                                                        Get Key (provider-specific) <IconExternalLink className="w-3 h-3" />
                                                    </Link>
                                                </Button>
                                            </div>
                                            <Input
                                        ...
                                        <CardContent className="pt-4">
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-muted-foreground">Click &quot;Launch Dashboard&quot; to start using LearnPath AI.</p>
                                                </div>
                                            </div>
                                        </CardContent>
                                    </Card>
