                ...
                <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            LearnPath AI (&quot;we&quot;, &quot;our&quot;, &quot;us&quot;) respects your privacy and is committed to protecting your personal data. This privacy policy explains how we collect, use, and safeguard your information when you use our application.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                            <li>Provide and personalize the LearnPath AI experience.</li>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            LearnPath AI integrates with third-party services (Gemini for AI, Resend for emails, Spotify for music). When you provide API keys, requests are made directly to these services. Please review their respective privacy policies.
                        </p>
                    </section>
