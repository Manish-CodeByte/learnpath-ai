...
export const metadata: Metadata = {
  title: "LearnPath AI",
  description: "Generate personalized curriculum roadmaps, track progress, and discover the best learning journey tailored to your goals.",
  icons: {
    icon: [
      { url: "/favicon.ico" },
      ...
      >
        <AuthProvider>
          <ThemeProvider
            ...
            themes={["light", "dark", "system", "theme-learnpath", "theme-purple", "theme-pink", "theme-pink-dark", "theme-midnight", "theme-forest", "theme-sunset", "theme-cyberpunk", "theme-coffee", "theme-nordic", "theme-cosmic", "theme-retro-pop", "theme-candy"]}
          >
            <StarfieldBackground />
            <XPProvider>
              <SWRProvider>
