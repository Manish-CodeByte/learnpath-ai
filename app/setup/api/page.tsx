            ...
            <div className="container mx-auto max-w-4xl px-4 py-16">
                <Link href="/" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground mb-8">
                    ...
                    <p className="text-muted-foreground text-lg">
                        LearnPath AI uses external APIs to power AI features and email notifications. This guide explains how to get and use these keys.
                    </p>
                </div>

                <div className="space-y-12">
                    {/* Gemini Section (placeholder for LLM provider) */}
                    <section className="p-6 rounded-2xl bg-card border border-border">
                        <div className="flex items-start gap-4 mb-6">
                            ...
                            <div>
                                <h2 className="text-2xl font-semibold mb-1">Gemini API (placeholder)</h2>
                                <p className="text-muted-foreground">Powers AI daily briefings, curriculum recommendations, and personalized learning suggestions.</p>
                            </div>
                        </div>

                        <div className="space-y-4 mb-6">
                            <h3 className="font-semibold">Why Gemini?</h3>
                            <p className="text-muted-foreground">
                                Gemini (or your preferred LLM) powers curriculum generation and tailored recommendations. Configure your API key in Settings to enable AI features in LearnPath AI.
                            </p>
                        </div>
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
                                ...
                                <li>Click <strong>Create API Key</strong> and give it a name (e.g., &quot;LearnPath AI&quot;).</li>
                                <li>Copy the key and paste it in your LearnPath AI settings or during onboarding.</li>
                            </ol>
                        </div>
                    ...
                    <section className="p-6 rounded-2xl bg-card border border-border">
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            <p className="text-muted-foreground">
                                Resend is a modern email API built for developers. Their <strong>free tier includes 3,000 emails/month</strong>—more than enough for daily LearnPath AI notifications.
                            </p>
                        </div>
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
                                ...
                                <li>Paste it in your LearnPath AI settings.</li>
                            </ol>
                        </div>
